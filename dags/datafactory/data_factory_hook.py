...
class AzureDataFactoryHook(BaseHook):
    ...
    def get_conn(self) -> DataFactoryManagementClient:
        ...
        credentials = ServicePrincipalCredentials(client_id=conn.login, secret=conn.password, tenant=extra_options.get("tenantId"))
        return DataFactoryManagementClient(credentials, extra_options.get("subscriptionId"))
    ...
    def _factory_exists(self, resource_group_name: str, factory_name: str) -> bool:
        """
    ...
    def _linked_service_exists(
            self, resource_group_name: str, factory_name: str, linked_service_name: str
    ) -> bool:
        """
    ...
    def _dataset_exists(self, resource_group_name: str, factory_name: str, dataset_name: str) -> bool:
        """
    ...
    def _pipeline_exists(self, resource_group_name: str, factory_name: str, pipeline_name: str) -> bool:
        """
    ...
    def _trigger_exists(self, resource_group_name: str, factory_name: str, trigger_name: str) -> bool:
        """
